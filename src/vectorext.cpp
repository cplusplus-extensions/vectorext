 ...
 * 
 * @param os The stream on which the elements are printed.
 ...
 * @warning This function requires a version of the C++ standard which supports rvalue references.
 */
 ...
 * 
 * @warning As of C++20, there are standard functions that allow two vectors to be joined. This hand-made version is therefore suitable for all C++ standard versions from C++11 onwards and prior to C++20.
 * @warning This function requires a version of the C++ standard which supports rvalue references.
 */
